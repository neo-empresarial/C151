...
.\venv\Scripts\pyinstaller --noconfirm --onedir --noconsole --icon "$PWD\src\public\icons\certi-icon.ico" --splash "$PWD\src\public\images\certi\splash-screen.png" --name "DeepFaceRec_Unified" `
    --specpath "build" `
