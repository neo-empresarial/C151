    ...
    with ui.column().classes('w-full p-2 pb-24'):
        ...
        def save_settings():
            ...
            save_tech = {
                ...
                "check_similarity": face_tech.get('check_similarity', False)
            }
        ...
        with ui.row().classes('w-full gap-4 mb-6'):
            with ui.column().classes('flex-1'):
                with ui.row().classes('items-center gap-2 mb-1'):
                    ui.label(lm.t('model_name'))
                    with ui.icon('help', size='xs').classes('text-gray-400 cursor-help'):
                         ui.tooltip(lm.t('desc_model_name')).classes('bg-gray-800 text-white text-xs')
                ui.select(
            ...
            with ui.column().classes('flex-1'):
                with ui.row().classes('items-center gap-2 mb-1'):
                    ui.label(lm.t('metric'))
                    with ui.icon('help', size='xs').classes('text-gray-400 cursor-help'):
                         ui.tooltip(lm.t('desc_distance_metric')).classes('bg-gray-800 text-white text-xs')
                ui.select(
        ...
        with ui.row().classes('items-center gap-2 mb-1'):
             ...
             with ui.icon('help', size='xs').classes('text-gray-400 cursor-help'):
                    ui.tooltip(lm.t('desc_required_hits')).classes('bg-gray-800 text-white text-xs')
        ...
        with ui.row().classes('items-center gap-2 mb-1'):
             ...
             with ui.icon('help', size='xs').classes('text-gray-400 cursor-help'):
                    ui.tooltip(lm.t('desc_threshold')).classes('bg-gray-800 text-white text-xs')
        ...
        with ui.row().classes('items-center gap-2 mb-1'):
             ...
             with ui.icon('help', size='xs').classes('text-gray-400 cursor-help'):
                    ui.tooltip(lm.t('desc_min_face')).classes('bg-gray-800 text-white text-xs')
        ...
        with ui.row().classes('items-center gap-2 mb-1'):
             ...
             with ui.icon('help', size='xs').classes('text-gray-400 cursor-help'):
                    ui.tooltip(lm.t('desc_max_offset')).classes('bg-gray-800 text-white text-xs')
